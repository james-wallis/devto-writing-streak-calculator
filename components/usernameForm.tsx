...
const UsernameForm = ({ onSubmit }: IProps) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="lg:w-1/3 md:w-1/2 w-full bg-white rounded-lg p-6 md:p-8 flex flex-col w-full">
            ...
            <button className="text-white bg-indigo-500 border-0 py-2 px-4 md:px-6 focus:outline-none hover:bg-indigo-600 rounded md:text-lg mt-2 md:mt-4">Calculate weekly streak</button>
        </form>
    )
}
